...
/*
Method: getDisableEdit

Gets the DisableEdit property of stocks (also applicable to flows). A DisableEdit stock cannot be edited.
...
The DisableEdit value of the stock. If an array of primitives was passed, returns an array of values.
...
/*
Method: getDisableDelete

Gets the DisableDelete property of stocks (also applicable to flows). A DisableDelete stock cannot be deleted.
...
The DisableDelete value of the stock. If an array of primitives was passed, returns an array of values.
...
/*
Method: setDisableEdit

Sets the DisableEdit value of the passed stocks (also applicable to flows).

Parameters:

primitive - The stock for which the DisableEdit value will be set. May also be an array of stocks in which case they will all be set to the same value.
disableEdit - The new disableEdit status for the stock. Either true or false.
...
function setDisableEdit(primitive,disableEdit){
	map(primitive, function(primitive) {
		setAttributeUndoable(primitive, "DisableEdit", disableEdit);
	});
}

/*
Method: setDisableDelete

Sets the DisableDelete value of the passed stocks (also applicable to flows).

Parameters:

primitive - The stock for which the DisableDelete value will be set. May also be an array of stocks in which case they will all be set to the same value.
disableDelete - The new disableDelete status for the stock. Either true or false.
...
function setDisableDelete(primitive,disableDelete){
	map(primitive, function(primitive) {
		setAttributeUndoable(primitive, "DisableDelete", disableDelete);
	});
}
